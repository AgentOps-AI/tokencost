...
# Prompt tokens are based on how many words and intermediate characters long the input is, and completion tokens are based on how long chatGPT's response is.
# You can use ChatGPT's webapp (which uses their tiktoken repo) to see how many tokens your phrase is: https://platform.openai.com/tokenizer
# However, when asking follow-up questions and to maintain context, everything above and including your follow-up question is considered a prompt and will cost prompt tokens.
